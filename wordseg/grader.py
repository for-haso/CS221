...
def add_parts_1(grader, submission):
    ...
    grader.addBasicPart('1d-1', t_1d_1, maxPoints=0, maxSeconds=2)
    ...
    grader.addPart('1d-2', t_1d_2, maxPoints=1, maxSeconds=2)
...
def add_parts_2(grader, submission):
    ...
    grader.addBasicPart('2c-1', t_2c_1, maxPoints=1, maxSeconds=2)
...
def add_parts_3(grader, submission):
    ...
    grader.addBasicPart('3a-1', t_3a_1, maxPoints=1, maxSeconds=2)
    ...
    grader.addPart('3a-2', t_3a_2, maxPoints=1, maxSeconds=2)
